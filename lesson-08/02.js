...
const startEggTimer = document.getElementById("egg-start");
const resetEggTimer = document.getElementById("egg-reset");
const displayEggTimer = document.getElementById("egg-timer");

let isEggTimerStarted = false;
let timerSetInterval;

startEggTimer.addEventListener("click", function () {
  if (isEggTimerStarted) {
    return;
  }
